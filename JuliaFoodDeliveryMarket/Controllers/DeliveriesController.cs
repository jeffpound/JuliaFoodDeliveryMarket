...
namespace JuliaFoodDeliveryMarket.Controllers
{
    public class DeliveriesController : Controller
    {
        ...
        public DeliveriesController(JuliaFoodDeliveryMarketContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,Item")] Delivery delivery)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Item")] Delivery delivery)
        {
            if (id != delivery.Id)
            {
                return NotFound();
